...
public final class MapsConstants {
	 ...
	 * navigate to it This must be used with {@link MapsConstants.MIME_GPS}
	 */
	...
	/**
	 * location parcelable extra that is returned when asking for a location using {@link MapsConstants.MIME_GPS}
	 */
