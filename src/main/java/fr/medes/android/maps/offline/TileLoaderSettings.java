...
public class TileLoaderSettings extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.maps__tile_loader_settings_content);
		...
		mZoomMinSpinner = (Spinner) findViewById(R.id.maps__offline_zoommin);
		mZoomMaxSpinner = (Spinner) findViewById(R.id.maps__offline_zoommax);
		mAreaSpinner = (Spinner) findViewById(R.id.maps__offline_area);

		mStartButton = findViewById(R.id.maps__offline_start);
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DIALOG_ZOOM_ERROR_ID:
			return new AlertDialog.Builder(this).setTitle(android.R.string.dialog_alert_title)
					.setMessage(R.string.maps__offline_zoom_error).setPositiveButton(android.R.string.ok, null)
					.create();
		default:
	...
	public void onClick(View v) {
		if (v.getId() == R.id.maps__offline_start) {
		...
		} else if (v.getId() == R.id.maps__offline_cancel) {
			finish();
